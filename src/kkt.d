...
csc* form_KKT(const csc  *P,
              ...
              c_int      *Pdiag_n,
              c_int      *param2toKKT) {
  c_int  nKKT;            // Size, number of nonzeros and max number of nonzeros in KKT matrix
  c_int  nnzKKTmax;       // Size, number of nonzeros and max number of nonzeros in KKT matrix
  csc   *KKT_trip;        // KKT matrix in triplet format and CSC format
  csc   *KKT;             // KKT matrix in triplet format and CSC format
